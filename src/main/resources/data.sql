...
values (1, 1, "2027-07-07 07:00:00", 1);
insert into Screening (movie_id, room_id, time, id)
values (3, 1, "2027-07-07 19:00:00", 2);
insert into Screening (movie_id, room_id, time, id)
values (4, 2, "2027-07-07 03:05:00", 3);
insert into Screening (movie_id, room_id, time, id)
values (2, 2, "2027-07-07 07:15:00", 4);
insert into Screening (movie_id, room_id, time, id)
values (3, 3, "2027-07-07 08:15:00", 5);
insert into Screening (movie_id, room_id, time, id)
values (5, 3, "2027-07-07 11:30:00", 6);